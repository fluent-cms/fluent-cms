...
public interface INosqlDao
{
    ...
    Task<Result<Record[]>> Query(string collectionName, IEnumerable<ValidFilter> filters, ImmutableArray<Sort>? sorts = null, ValidCursor? cursor = null, Pagination? pagination = null);
}