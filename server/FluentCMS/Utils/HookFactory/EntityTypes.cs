...
public record EntityPreGetListArgs(string Name, LoadedEntity Entity,ImmutableArray<ValidFilter> RefFilters, ImmutableArray<Sort> RefSorts, ValidPagination RefPagination):BaseArgs(Name) ;
