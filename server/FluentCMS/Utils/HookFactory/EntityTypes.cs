...
public record EntityPreGetListArgs(string Name,ImmutableArray<ValidFilter> RefFilters, ImmutableArray<Sort> RefSorts, ValidPagination RefPagination):BaseArgs(Name) ;
