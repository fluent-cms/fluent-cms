...
public record EntityPreGetListArgs(string Name,ImmutableArray<ValidFilter> RefFilters, ImmutableArray<Sort> RefSorts, Pagination RefPagination):BaseArgs(Name) ;
