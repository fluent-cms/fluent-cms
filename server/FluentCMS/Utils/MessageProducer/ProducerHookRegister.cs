...
public class ProducerHookRegister(HookRegistry registry, IMessageProducer messageProducer, ILogger<ProducerHookRegister> logger)
{
    ...
    {
        registry.AddHook(entityName, Occasion.AfterInsert, (RecordMeta meta,Record record) =>
        {
        ...
        registry.AddHook(entityName, Occasion.AfterUpdate, (RecordMeta meta,Record record) =>
        {
        ...
        registry.AddHook(entityName, Occasion.AfterDelete, (RecordMeta meta,Record record) =>
        {
