...
{
    Task<ListResult?> List(string name,Pagination pagination, QueryStrArgs args, CancellationToken token);
    ...
    Task<ListResult> CrosstableList(string name, string id, string attr, bool exclude, QueryStrArgs args, Pagination pagination, CancellationToken token);
